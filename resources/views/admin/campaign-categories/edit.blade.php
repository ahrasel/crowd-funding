    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST"
                        action="{{ route('campaign-categories.update', ['campaign_category' => $campaignCategory->id]) }}">
                        @csrf
                        @method('PATCH')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="name" id="name" class="form-control" placeholder="name"
                                aria-describedby="name" value="{{ $campaignCategory->name }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="description" id="description"
                                rows="3">{{ $campaignCategory->description }}</textarea>
                        </div>
